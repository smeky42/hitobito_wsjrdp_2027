...
module Sheet
  # "Buchhaltung" -- the fourth sub-item of the Finanzen main-nav section,
  ...
  class Fin::Accounting < Base
    ...
    tab "fin.tabs.booking_batches", :booking_batches_path
    tab "fin.tabs.cost_centers", :cost_centers_path
    tab "fin.tabs.ledger_accounts", :ledger_accounts_path
    tab "fin.tabs.personal_accounts", :personal_accounts_path

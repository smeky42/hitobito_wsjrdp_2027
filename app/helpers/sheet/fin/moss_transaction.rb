...
module Sheet
  class Fin::Moss < Base
    # Sheet of Fin::MossTransactionsController (controller
    # "fin/moss_transactions" -> Sheet::Fin::MossTransaction). Only the

...
module Wsjrdp2027::UserContext
  ...
  # both as the tier's permission, nil without any finance permission. They
  # differ exactly when the cap changes something, which is what the layout
  # bar (layouts/_wsjrdp_finance_cap) shows.
  def finance_tier

...
# built (Wsjrdp2027::UserContext). Nothing else changes -- the cap only ever
...
module Wsjrdp2027::FinanceCap
  # Ascending, i.e. index == rank.
  TIERS = Wsjrdp2027::FinanceAccess::FINANCE_TIERS
  ...
  # The highest tier in a permission set, nil without any.
  def highest(permissions)
    (TIERS & permissions).last
  end

...
# splits a value on, "~" is unreserved); see doc/wsjrdp/url_encoding.md.
#
# SECURITY -- the encapsulation rule (doc/wsjrdp/url_encoding.md §6): the %XX -> literal
...
# (spec/domain/wsjrdp/relaxed_url_query_spec.rb).
module Wsjrdp::RelaxedUrlQuery
  ...
  # relax from outside (`str.gsub(Wsjrdp::RelaxedUrlQuery::RELAXATION_PATTERN, ...)`).
  ...
  def to_query(params)
    unless params.is_a?(Hash)
      raise TypeError, "Wsjrdp::RelaxedUrlQuery.to_query expects a Hash, got #{params.class}"
    end

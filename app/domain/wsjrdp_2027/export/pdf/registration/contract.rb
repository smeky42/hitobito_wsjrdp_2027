  ...
  module Export::Pdf::Registration
    class Contract < Section
      ...
      def list
        ...
        pdf.move_down 3.mm
        text "Hiermit #{@person.years.to_i >= 18 ? "melde ich mich" :  "melden wir unser Kind"}, #{@person.full_name} geboren am #{@person.birthday}, verbindlich mit dem Paket für #{person_payment_role_full_name(@person)} zur Teilnahme im Deutschen Kontingent zum 26. World Scout Jamboree 2027 an. Mit der Anmeldung #{@person.years.to_i >= 18 ? "akzeptiere ich" : "akzeptieren wir"} die Reisebedingungen, die vom rdp als Veranstalter vorgegeben werden."
        ...
        text "Den Medizinbogen, die Fotohinweise und das SEPA-Mandat im Anhang haben #{@person.years.to_i >= 18 ? "habe ich" : "haben wir"} gesondert unterschrieben."

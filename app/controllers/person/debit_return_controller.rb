...
class Person::DebitReturnController < ApplicationController
  ...
  def update
    ...
    if !@person.changed?
      reload_or_return notice: "Angaben zu Rücklastschriften wurden nicht verändert"
    elsif @person.save
      reload_or_return notice: "Angaben zu Rücklastschriften wurden erfolgreich geändert"
    else

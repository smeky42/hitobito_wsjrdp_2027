...
ActiveRecord::Schema[7.1].define(version: 2025_10_17_080808) do
  ...
  create_table "accounting_entries", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_accounting_on_subject_id"
  ...
  add_foreign_key "accounting_entries", "people"
